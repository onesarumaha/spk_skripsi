...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('frontend-dash/template/vendors/typicons/typicons.css') }}">
        <link rel="stylesheet" href="{{ asset('frontend-dash/template/vendors/css/vendor.bundle.base.css') }}">
        <!-- endinject -->
        <!-- plugin css for this page -->
        <!-- End plugin css for this page -->
        <!-- inject:css -->
        <link rel="stylesheet" href="{{ asset('frontend-dash/template/css/vertical-layout-light/style.css') }}" />
        <!-- endinject -->
        <link rel="shortcut icon" href="{{ asset('frontend-dash/template/images/favicon.png') }}" />
    </head>
    <body>
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            >
                                <a class="dropdown-item">
                                    <i
                                        class="typcn typcn-cog-outline text-primary"
                                    ></i>
                                    Settings
                                </a>
                                <a class="dropdown-item">
                                    <i
                                        class="typcn typcn-eject text-primary"
                                    ></i>
                                    Logout
                                </a>
                            </div>
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <div class="preview-icon bg-warning">
                                            <i
                                                class="typcn typcn-cog-outline mx-0"
                                            ></i>
                                        </div>
                                    </div>
                                    <div class="preview-item-content">
            ...
            <div class="container-fluid page-body-wrapper">
                            ...
                            <div class="list-wrapper px-3">
                                ...
                                >
                                    <li>
                                        ...
                                        <i
                                            class="remove typcn typcn-delete-outline"
                                        ></i>
                                    </li>
                                    <li>
                                        <div class="form-check">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="typcn typcn-chart-pie-outline menu-icon"
                                ></i>
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="typcn typcn-th-small-outline menu-icon"
                                ></i>
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="typcn typcn-user-add-outline menu-icon"
                                ></i>
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="typcn typcn-globe-outline menu-icon"
                                ></i>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="row">
                            <div
                                class="col-xl-6 grid-margin stretch-card flex-column"
                            >
                                ...
                                <div class="row h-100">
                                    <div
                                        class="col-md-6 stretch-card grid-margin grid-margin-md-0"
                                    >
                                        <div class="card">
                                            <div
                                                class="card-body d-flex flex-column justify-content-between"
                        ...
                        <div class="row">
                            <div class="col-xl-4 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body border-bottom">
                                        ...
                                        >
                                            <h6
                                                class="mb-2 mb-md-0 text-uppercase font-weight-medium"
                                            >
                                                Overall sales
                                            </h6>
                                            <div class="dropdown">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <i
                                                        class="typcn typcn-arrow-up-thick text-success"
                                                    ></i>
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <i
                                                        class="typcn typcn-arrow-down-thick text-danger"
                                                    ></i>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            >
                                <div class="row">
                                    ...
                                    >
                                        <div
                                            class="card newsletter-card bg-gradient-warning"
                                        >
                                            <div class="card-body">
                                                <div
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            class="btn btn-danger btn-rounded mt-1"
                                                            type="submit"
                                                        >
                                                            Subscribe
                                                        </button>
                                    ...
                                    <div class="col-md-12 stretch-card">
                                        <div
                                            class="card profile-card bg-gradient-primary"
                                        >
                                            <div class="card-body">
                                                <div
                                                ...
                                                >
                                                    <div class="col-md-4">
                                                        <figure
                                                            class="avatar mx-auto mb-4 mb-md-0"
                                                        >
                                                            <img
                                                                src="images/faces/face20.jpg"
                                                                alt="avatar"
                                                            />
                                                        </figure>
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        >
                                            <div>
                                                <p
                                                    class="mb-2 text-md-center text-lg-left"
                                                >
                                                    Total Expenses
                                                </p>
                                            ...
                                            <i
                                                class="typcn typcn-briefcase icon-xl text-secondary"
                                            ></i>
                                        </div>
                                        <canvas
                                            id="expense-chart"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <i
                                                class="typcn typcn-chart-pie icon-xl text-secondary"
                                            ></i>
                                        </div>
                                        <canvas
                                            id="budget-chart"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <i
                                                class="typcn typcn-clipboard icon-xl text-secondary"
                                            ></i>
                                        </div>
                                        <canvas
                                            id="balance-chart"
                                                    ...
                                                    <td>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                Delete
                                                                <i
                                                                    class="typcn typcn-delete-outline btn-icon-append"
                                                                ></i>
                                                            </button>
                                                        </div>
                                                    </td>
        ...
        <!-- base:js -->
        <script src="{{ asset('frontend-dash/template/vendors/js/vendor.bundle.base.js')}}"></script>
        <!-- endinject -->
        <!-- Plugin js for this page-->
        <script src="{{ asset('frontend-dash/template/vendors/chart.js/Chart.min.js')}}"></script>
        <!-- End plugin js for this page-->
        <!-- inject:js -->
        <script src="{{ asset('frontend-dash/template/js/off-canvas.js')}}"></script>
        <script src="{{ asset('frontend-dash/template/js/hoverable-collapse.js')}}"></script>
        <script src="{{ asset('frontend-dash/template/js/template.js')}}"></script>
        <script src="{{ asset('frontend-dash/template/js/settings.js')}}"></script>
        <script src="{{ asset('frontend-dash/template/js/todolist.js')}}"></script>
        <!-- endinject -->
